...
{
    public class Dark_Color : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the Dark_Color class.
        /// </summary>
        public Dark_Color()
          : base("Dark_Color", "Dark",
              "深色",
              "star", "Display")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Color result = star_Color.dark(colora, colorb);
            DA.SetData(0, result);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.dark_color;
            }
        }
        ...
        {
            get { return new Guid("e5883ddc-e86c-4e0b-9a05-51aeb11c63f5"); }
        }
    }
}